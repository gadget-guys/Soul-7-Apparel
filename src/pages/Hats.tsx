...
const Hats = () => {
  ...
  useEffect(() => {
    ...
    console.log('Hats component mounted, path:', location.pathname);
    console.log('Hats data available:', hatsProducts.length);
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-black">
        <div className="flex flex-col items-center">
          ...
          <p className="mt-4 text-gray-300 font-playfair">Loading hats...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <section className="relative h-80 md:h-96 overflow-hidden mb-12">
            <div className="absolute inset-0 z-0">
              <img 
                src="https://images.unsplash.com/photo-1576871337622-98d48d1cf531?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3" 
                alt="Hats Collection" 
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full text-center">
              <FadeIn>
                ...
                <p className="text-lg md:text-xl text-gray-100 max-w-2xl">
                  Stylish headwear crafted with premium materials
                </p>
              </FadeIn>
            </div>
          </section>
          ...
          <section className="py-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {hatsProducts.map((product, index) => (
                <HatCard key={product.id} product={product} index={index} />
              ))}
            </div>
